...
IncludePackagePath     :=
IncludeCPath           := $(IncludeSwitch). $(IncludeSwitch)../../../../../../encrypt/AES $(IncludeSwitch)../../../../board/wujian100_open_evb/include $(IncludeSwitch)../../../../csi_core/include $(IncludeSwitch)../../../../csi_driver/include $(IncludeSwitch)../../../../csi_driver/wujian100_open/include $(IncludeSwitch)../../../../csi_kernel/include $(IncludeSwitch)../../../../libs/include $(IncludeSwitch)../configs $(IncludeSwitch)../AES $(IncludeSwitch)../LED $(IncludeSwitch)../key_gpio_intr $(IncludeSwitch)../oled128_32 $(IncludeSwitch)../sd_driver $(IncludeSwitch)../tiny-AES-c  
IncludeAPath           := $(IncludeSwitch). $(IncludeSwitch)../../../../../../encrypt/AES $(IncludeSwitch)../configs $(IncludeSwitch)../AES $(IncludeSwitch)../LED $(IncludeSwitch)../key_gpio_intr $(IncludeSwitch)../oled128_32 $(IncludeSwitch)../sd_driver $(IncludeSwitch)../tiny-AES-c  
...
$(IntermediateDirectory)/$(OutputFile):  $(Objects) Always_Link 
	$(LinkerName) $(OutputSwitch) $(IntermediateDirectory)/$(OutputFile)$(ExeSuffix) $(LinkerNameoption) $(LinkOtherFlagsOption)  @$(ObjectsFileList) $(LibraryPathSwitch)F:/Nexysvideo_wujian100/AES_nexysvideo/sdk/libs  -Wl,--whole-archive $(LibrarySwitch)newlib_wrap   -Wl,--no-whole-archive  $(LinkOptions) $(LibPath) $(Libs)
...
$(IntermediateDirectory)/tiny-AES-c_aes$(ObjectSuffix): ../tiny-AES-c/aes.c  
